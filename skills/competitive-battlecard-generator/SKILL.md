...
description: Use when analyzing competitors, creating sales battlecards, building competitive positioning, preparing for competitive deals, or updating competitive intelligence. Triggers: 'battlecard for [competitor]', 'competitive analysis of [competit
source: github:Othmane-Khadri/gtm-engineer-playbook
---
...
7. **Include a refresh date.** Every battlecard must include a "Last Updated" date and a note that battlecards
