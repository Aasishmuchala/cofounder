---
name: clone-site
description: description: Clone any website into a pixel-perfect Next.js replica. Point it at a URL and it reverse-engineers the design, extracts assets, and rebuilds it section by section using parallel builder agents. Use when asked to clone, copy, re
source: github:ericosiu/ai-marketing-skills
---
